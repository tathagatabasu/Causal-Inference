...
tend to maximise the predictive performance of the outcome model only. This can be problematic under limited information,
as the consequence of mistreatment can be harmful. 
So, in this paper, we develop our model using
...
the outcom, as this increases the posterior expectation of the selection

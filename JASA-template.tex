...
%%% MT to TB: the definition on the next line sounds wrong (at least in the usual sense of "confounder"); a confounder in causal inference is a variable which causes both a predictor and the outcome, giving the false impression that this predictor causes the outcome

...
for treatment decision. That is, in a very intuitive 
situation, we can observe blood pressure with some
...
side effects. In general, this cannot be associated 
...
problem as a decision support for treating a subject.

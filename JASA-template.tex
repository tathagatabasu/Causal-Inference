...
%%% MT to TB: the definition on the next line sounds wrong (at least in the usual sense of "confounder"); I've added a definition and clarification as well as a figure; please check
% Confounders are variables associated with both the treatment and the outcome.
\begin{figure}
\begin{center}
...
%%% MT to TB: I added next line for clarity
...
could be the fact that in both the cases, the number of active $\beta_j$ is
higher than $\gamma_j$
% latex table generated in R 4.3.2 by xtable 1.8-4 package

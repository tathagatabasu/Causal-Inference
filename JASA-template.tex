...
found in \cite{rubin1978}. Lately with the notion of variable selection
of high dimensional problems, Bayesian methodologies have become
more significant.
...
\end{align}
This relies on an important assumption that the treatment effect

...
%%% MT to TB: added text starts here
\begin{figure}
\begin{center}
...
%%% MT to TB: changed "confounder identification" to "predictor selection"
...
%%% MT to TB: added this for clarity
...
%%% MT to TB: treatment -> treatment decision
treatment decision.
...
%%% MT to TB: added independence statement as used later
independent of $T_i$ and $X_i$.
%%% MT to TB: added for clarity

...
set3_sum_beta_trt = c()
for (k in 0:4) {
  set3_sum_beta_trt = cbind(set3_sum_beta_trt, rbind(min(range(get(paste0("set3_casual_", k)))), max(range(get(paste0("set3_casual_", k)))), NA, NA, get(paste0("set3_BSSL_", k))$means[52]))
}

for (k in 5:35) {
  set3_sum_beta_trt = cbind(set3_sum_beta_trt, rbind(min(range(get(paste0("set3_casual_", k)))), max(range(get(paste0("set3_casual_", k)))), get(paste0("set3_SSCE_", k))$mean.trt.effect, get(paste0("set3_BSSCE_", k))$mean.trt.effect, get(paste0("set3_BSSL_", k))$means[52]))
}

set4_sum_beta_trt = c()
for (k in 0:4) {
  set4_sum_beta_trt = cbind(set4_sum_beta_trt, rbind(min(range(get(paste0("set4_casual_", k)))), max(range(get(paste0("set4_casual_", k)))), NA, NA, get(paste0("set4_BSSL_", k))$means[52]))
}

for (k in 5:35) {
  set4_sum_beta_trt = cbind(set4_sum_beta_trt, rbind(min(range(get(paste0("set4_casual_", k)))), max(range(get(paste0("set4_casual_", k)))), get(paste0("set4_SSCE_", k))$mean.trt.effect, get(paste0("set4_BSSCE_", k))$mean.trt.effect, get(paste0("set4_BSSL_", k))$means[52]))
}
...
for (k in 16:35) {
  set3_sum_loss = rbind(set3_sum_loss, cbind(sum(which(colMeans(get(paste0("set3_active_",k)))==1) > 10), 
                                             ...
                                             NA, NA,
                                             NA, NA,
                                             sum(which(get(paste0("set3_BSSL_", k))$IP[1:50]>=0.5) >10),
                                             sum(which(get(paste0("set3_BSSL_", k))$IP[1:50]<0.5) <=10)))
}
...
for (k in 16:35) {
  set4_sum_loss = rbind(set4_sum_loss, cbind(sum(which(colMeans(get(paste0("set4_active_",k)))==1) > 15), 
                                             ...
                                             NA, NA,
                                             NA, NA,
                                             sum(which(get(paste0("set4_BSSL_", k))$IP[1:50]>=0.5) >15),
                                             sum(which(get(paste0("set4_BSSL_", k))$IP[1:50]<0.5) <=15)))
}

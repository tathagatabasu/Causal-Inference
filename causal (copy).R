...
beta2 = c(seq(-5,-1, length.out = 10), 1:5)
gamma2 = c(seq(-5,-1, length.out = 10), 1:5)

a2_dum_all = 1/(1 + exp(-x_all[,1:length(gamma2)] %*% gamma2))
...
if(T){
  ...
  for (k in 1:11) { #
    ...
    val1 = sum(abs(cor(x,y1))>0.2)
    val2 = sum(abs(cor(x,y1))>0.4)
...
if(T){
  ...
  plot(seq(25,75, by = 5), set1_sum_beta_trt[1,], type = "l", col = "red", lty = 2, ylab = "Treatment effect", xlab = "Observations", ylim = c(min(set1_sum_beta_trt), max(set1_sum_beta_trt)))
  lines(seq(25,75, by = 5), set1_sum_beta_trt[2,], type = "l", col = "red", lty = 2)
  lines(seq(25,75, by = 5), set1_sum_beta_trt[3,], type = "l", col = "blue", lty = 3)
  lines(seq(25,75, by = 5), set1_sum_beta_trt[4,], type = "l", col = "green", lty = 4)
  lines(seq(25,75, by = 5), set1_sum_beta_trt[5,], type = "l", col = "brown", lty = 5)
  legend("bottomright", 
         ...
         bty = "n" , 
         bg = "transparent" )
  plot(seq(25,75, by = 5), set2_sum_beta_trt[1,], type = "l", col = "red", lty = 2, ylab = "Treatment effect", xlab = "Observations", ylim = c(min(set2_sum_beta_trt), max(set2_sum_beta_trt)))
  lines(seq(25,75, by = 5), set2_sum_beta_trt[2,], type = "l", col = "red", lty = 2)
  lines(seq(25,75, by = 5), set2_sum_beta_trt[3,], type = "l", col = "blue", lty = 3)
  lines(seq(25,75, by = 5), set2_sum_beta_trt[4,], type = "l", col = "green", lty = 4)
  lines(seq(25,75, by = 5), set2_sum_beta_trt[5,], type = "l", col = "brown", lty = 5)
  ...
  par(mfrow = c(2,1), mar = c(4.5,4,1,1))
  plot(seq(25,75, by = 5), set3_sum_beta_trt[1,], type = "l", col = "red", lty = 2, ylab = "Treatment effect", xlab = "Predictors", ylim = c(min(set3_sum_beta_trt), max(set3_sum_beta_trt)))
  lines(seq(25,75, by = 5), set3_sum_beta_trt[2,], type = "l", col = "red", lty = 2)
  lines(seq(25,75, by = 5), set3_sum_beta_trt[3,], type = "l", col = "blue", lty = 3)
  lines(seq(25,75, by = 5), set3_sum_beta_trt[4,], type = "l", col = "green", lty = 4)
  lines(seq(25,75, by = 5), set3_sum_beta_trt[5,], type = "l", col = "brown", lty = 5)
  plot(seq(25,75, by = 5), set4_sum_beta_trt[1,], type = "l", col = "red", lty = 2, ylab = "Treatment effect", xlab = "Predictors", ylim = c(min(set4_sum_beta_trt), max(set4_sum_beta_trt)))
  lines(seq(25,75, by = 5), set4_sum_beta_trt[2,], type = "l", col = "red", lty = 2)
  lines(seq(25,75, by = 5), set4_sum_beta_trt[3,], type = "l", col = "blue", lty = 3)
  lines(seq(25,75, by = 5), set4_sum_beta_trt[4,], type = "l", col = "green", lty = 4)
  lines(seq(25,75, by = 5), set4_sum_beta_trt[5,], type = "l", col = "brown", lty = 5)
  legend("bottomleft",
         legend = c("RBCE", "SSCE", "BSSCE", "BSSL"),
         col = c("red", "blue", "green", "brown"),
         lty = c(2,3,4,5),
